...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "btn-primary relative overflow-hidden border border-primary bg-primary text-primary-foreground shadow-[inset_0_1px_hsl(var(--primary-foreground)/0.4),0_4px_6px_-1px_rgb(0_0_0/0.1),0_2px_4px_-2px_rgb(0_0_0/0.1)] hover:bg-[hsl(var(--primary-foreground)/0.9)] active:bg-primary active:shadow-[inset_0_1px_hsl(var(--primary-foreground)/0.2)]",
        destructive:
